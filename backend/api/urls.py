...
from api.views import (AuthToken, ControlFavoriteRecipe, ControlShoppingCart,
                       ControlSubscription, IngredientViewSet, RecipesViewSet,
                       set_password, TagViewSet, UsersViewSet)
